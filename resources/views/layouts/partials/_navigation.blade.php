<div class="sidenav primary-color light-font">
  ...
  <a href="{{url('proveedores')}}"><div class="icon-nav"><i class="fas fa-shipping-fast fa-2x"></i></div><div class="text-nav">Proveedores</div></a>
  <a href="{{url('venta')}}"><div class="icon-nav"><i class="fas fa-shopping-basket fa-2x"></i></div><div class="text-nav">Ventas</div></a>
  <a href="{{url('reportes')}}"><div class="icon-nav"><i class="fas fa-chart-pie fa-2x"></i></div><div class="text-nav">Reportes</div></a>
  <a href="{{url('administrarUsuarios')}}"><div class="icon-nav"><i class="fas fa-cogs fa-2x"></i></div><div class="text-nav">Administrar usuarios</div></a>
</div>
